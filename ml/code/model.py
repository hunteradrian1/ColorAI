...
class Model():
    def __init__(self):
        ...
        # Load pre-trained VGG19 as encoder
        vgg19 = VGG19(
            include_top=False,
            weights="imagenet",
        ...
        for filters, layer_name in block_layer_sizes:
            ...
            b = LeakyReLU(alpha=0.1)(b)
            b = BatchNormalization()(b)
            # Second conv transpose with upsampling
        ...
        # Output 2 channels for AB color space
    ...
    def percept_loss_func(self, truth, predicted):
        ...
        # Calculate MSE at different scales
